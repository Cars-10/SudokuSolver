pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~sudoku.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~sudoku.adb");
...
package body ada_main is
   ...
   E066 : Short_Integer; pragma Import (Ada, E066, "ada__strings__utf_encoding_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_sudoku");
...
--  BEGIN Object file/option list
   --   ./sudoku.o
   --   -L./
   --   -L/Users/cars10/.local/share/alire/toolchains/gnat_native_15.1.2_60748c54/lib/gcc/aarch64-apple-darwin23.6.0/15.0.1/adalib/
   --   -static
   --   -lgnarl
   --   -lgnat
