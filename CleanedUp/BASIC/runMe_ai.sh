...
# QB64PE location
QB64PE="/Users/cars10/GIT/SudokuSolver/AI-2025/BASIC/qb64pe/qb64pe"
COMPILED_BINARY="/Users/cars10/GIT/SudokuSolver/AI-2025/BASIC/Sudoku"
...
for matrix in $PATTERN; do
    ...
    # Execute the compiled BASIC binary
    /usr/bin/time -l "$COMPILED_BINARY" "$matrix" > "$tmp_out" 2> "$tmp_err"
