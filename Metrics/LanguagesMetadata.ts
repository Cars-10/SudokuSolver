...
export const orderedLanguages = [
    ...
    "Java", "C#", "F#", "Scala", "Kotlin", "Swift", "Dart", "Julia", "R", "Haxe",
...
export const quotes: Record<string, string> = {
    ...
    "C#": "Microsoft's answer to the monolith. Sleek, refined, but locked in the garden.",
...
export const languageHistories: Record<string, string> = {
    ...
    "C#": "2000. Designed by Anders Hejlsberg, C# blends modern language features with the .NET runtime to support enterprise, desktop and web applications. It emphasizes tooling, libraries and developer productivity.",
    ...
    "F#": "2005. F# brings functional-first programming to .NET with strong typing, succinct syntax and excellent interop, used in finance, analytics and domain modelling.",
