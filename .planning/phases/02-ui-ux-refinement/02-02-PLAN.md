...
<tasks>
  <task id="ui-fullscreen-01" title="Install screenfull">
    <description>
  ...
  <task id="ui-fullscreen-02" title="Inline screenfull in HTMLGenerator">
    <description>
  ...
  <task id="ui-fullscreen-03" title="Update Toggle Logic">
    <description>
  ...
  <task id="ui-fullscreen-04" title="Fix Re-entry Bug in Report Client">
    <description>
...
<verification_criteria>
  - [ ] `screenfull` library is included in the generated HTML.
  - [ ] Fullscreen toggle uses `screenfull` API.
  - [ ] Exiting fullscreen automatically stops the Matrix Race screensaver.
  - [ ] Visual indicator shows active fullscreen state.
</verification_criteria>
