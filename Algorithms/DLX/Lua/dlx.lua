...
-- Dancing Links (DLX) Algorithm X Sudoku Solver
-- Lua implementation following C reference exactly
-- Global iteration counter

local dlx_iterations = 0
local DEBUG = false
...
local function dlx_search(root, k, solution)
    dlx_iterations = dlx_iterations + 1  -- Count every search call
