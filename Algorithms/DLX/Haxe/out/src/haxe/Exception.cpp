...
HX_DEFINE_STACK_FRAME(_hx_pos_f707a01425baf2ae_39_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","/opt/homebrew/lib/haxe/std/cpp/_std/haxe/Exception.hx",39,0x4c4ce301)
...
void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_f707a01425baf2ae_39_new)
